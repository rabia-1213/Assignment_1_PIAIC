...
let choice = "fruits"; // Assume the customer wants to buy fruits
if (choice === "fruits") {
...
if (totalBill > 10) {
    ...
    let discount = totalBill * 0.1; // 10% discount
...
let paymentMethod = "credit card"; // Assume the customer prefers to pay by credit card
